	...
	<div class="container">
		<div class="row justify-content-center text-center mb-3">
			<div class="col-lg-8 col-xl-7">
				<span class="text-muted">Nos Services</span>
				<h2 class="display-5 fw-bold">Nos <span class="text-primary">Services</span> </h2>
				<p class="lead">Notre Agence de Location Offre une liste de services tels que</p>
			</div>
		</div>
		<div class="row g-4 g-md-5">
			<div class="col-md-6 col-xl-4">
				...
				<h5 class="mt-2 mt-md-3 fw-bold">Location de véhicules</h5>
				<p>Nous Proposons une variété de véhicules à louer </p>
			</div>
			<div class="col-md-6 col-xl-4">
				<div class="text-primary mb-3">
				...
				<h5 class="mt-2 mt-md-3 fw-bold">Facile à Utiliser</h5>
				<p>La plateform est Simple et Facile</p>
			</div>
			<div class="col-md-6 col-xl-4">
				<div class="text-primary mb-3">
				...
				<h5 class="mt-2 mt-md-3 fw-bold">Accessoires et équipements</h5>
				<p>Proposer des équipements supplémentaires tels que des sièges de sécurité pour enfants, des GPS,</p>
			</div>
			<div class="col-md-6 col-xl-4">
				<div class="text-primary mb-3">
				...
				<h5 class="mt-2 mt-md-3 fw-bold">Réservation en ligne et en personne</h5>
				<p>Permettre aux clients de réserver des véhicules en ligne via un site Web convivial, ainsi que de réserver en personne dans les agences de location.</p>
			</div>
			<div class="col-md-6 col-xl-4">
				<div class="text-primary mb-3">
				...
				<h5 class="mt-2 mt-md-3 fw-bold">Assistance routière </h5>
				<p>Offrir une assistance routière 24h/24 et 7j/7 en cas de panne, de pneu crevé ou de problème mécanique pendant la location.</p>
			</div>
			<div class="col-md-6 col-xl-4">
				<div class="text-primary mt-2 mt-md-3">
				...
				<h5 class="mt-2 mt-md-3 fw-bold">Location à long terme</h5>
				<p> Proposer des tarifs réduits pour les locations de longue durée, comme les locations mensuelles ou annuelles, pour les clients ayant besoin de véhicules pendant une période prolongée.</p>
			</div>
		</div>
	</div>
</section>
